    ...
    <form @submit="register">
      <div class="mb-3 w-50">
        ...
        <input
          ...
          class="form-control"
          id="maNhanVien"
          v-model="nhanVienLocal.maNhanVien"
        />
      </div>
      <div class="mb-3 w-50">
        ...
        <input
          ...
          class="form-control"
          id="tenNhanVien"
          v-model="nhanVienLocal.hoTenNhanVien"
        />
      </div>
      <div class="mb-3 w-50">
      ...
      <div class="mb-3 w-50">
        ...
        <input
          ...
          class="form-control"
          id="dienThoai"
          v-model="nhanVienLocal.dienThoai"
        />
      </div>
...
export default {
  ...
  methods: {
    register() {
      if (
        !this.nhanVienLocal.maNhanVien ||
        !this.nhanVienLocal.hoTenNhanVien ||
        !this.nhanVienLocal.chucVu ||
        !this.nhanVienLocal.password ||
        !this.nhanVienLocal.diaChi ||
        !this.nhanVienLocal.dienThoai
      ) {
